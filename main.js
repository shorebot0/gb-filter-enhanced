...
// --- NATIVE DIALOGUE BOX INJECTION ---
(() => {
    const canvasEl = document.getElementById("canvas_main");
    if (!canvasEl) return;

    // Load retro pixel font natively
    const fontLink = document.createElement("link");
    fontLink.rel = "stylesheet";
    fontLink.href = "https://fonts.googleapis.com/css2?family=Press+Start+2P&display=swap";
    document.head.appendChild(fontLink);

    // Build text input box element below the canvas
    ...
    // Build the visual overlay canvas layer
    ...
    // Hook cleanly into the WebGL drawing cycle
    const originalFlush = WebGLRenderingContext.prototype.flush;
    WebGLRenderingContext.prototype.flush = function() {
        originalFlush.apply(this);
        ...
        // Fixed scoping error: track global variables directly instead of window object
